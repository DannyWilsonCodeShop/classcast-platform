...
export function StudentTabBar({ assignmentId, onPostClick }: StudentTabBarProps) {
  ...
  return (
    <>
      ...
      <div className="shrink-0 h-[72px] native-bottom-nav" />
      <nav className="fixed bottom-0 left-0 right-0 z-40 px-1 py-2 native-bottom-nav" style={{ background: 'rgba(255,255,255,0.72)', backdropFilter: 'blur(20px) saturate(180%)', WebkitBackdropFilter: 'blur(20px) saturate(180%)', borderTop: '1px solid rgba(0,85,135,0.08)', boxShadow: '0 -4px 30px rgba(0,0,0,0.06)' }}>
