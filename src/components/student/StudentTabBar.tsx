    ...
    <>
      ...
      <nav className="fixed bottom-4 left-4 right-4 z-40 px-2 py-2 rounded-2xl native-bottom-nav" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(24px) saturate(180%)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', border: '1px solid rgba(255,255,255,0.25)', boxShadow: '0 8px 32px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.3)' }}>
        <div className="relative flex items-center justify-around">
          ...
          {activeIdx >= 0 && (
            <div
              className="absolute top-0 bottom-0 rounded-xl transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]"
              style={{
                width: '20%',
                left: `${activeIdx * 20}%`,
                ...
                boxShadow: '0 2px 12px rgba(0,85,135,0.1), inset 0 1px 0 rgba(255,255,255,0.5)',
                border: '1px solid rgba(255,255,255,0.4)',
              }}
            />
          )}
          <button className="relative flex flex-col items-center min-w-0 py-1 z-10 transition-transform duration-300" style={{ transform: isActive('/student/dashboard') ? 'scale(1.15) translateY(-2px)' : 'scale(1)' }} onClick={() => router.push('/student/dashboard')}>
          ...
          <button className="flex flex-col items-center min-w-0 transition-transform duration-200" style={{ transform: isActive('/student/assignments') ? 'scale(1.15) translateY(-2px)' : 'scale(1)' }} onClick={() => router.push('/student/assignments')}>
          ...
          <button className="relative flex flex-col items-center min-w-0 py-1 z-10 transition-transform duration-300" onClick={handlePostClick}>
          ...
          <button className="relative flex flex-col items-center min-w-0 py-1 z-10 transition-transform duration-300" style={{ transform: isActive('/student/courses') ? 'scale(1.15) translateY(-2px)' : 'scale(1)' }} onClick={() => router.push('/student/courses')}>
          ...
          <button className="relative flex flex-col items-center min-w-0 py-1 z-10 transition-transform duration-300" style={{ transform: isActive('/student/profile') ? 'scale(1.15) translateY(-2px)' : 'scale(1)' }} onClick={() => router.push('/student/profile')}>
