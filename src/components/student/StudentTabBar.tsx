    ...
    <>
      ...
      <nav className="fixed bottom-4 left-4 right-4 z-40 px-2 py-2 rounded-2xl native-bottom-nav" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(24px) saturate(180%)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', border: '1px solid rgba(255,255,255,0.25)', boxShadow: '0 8px 32px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.3)' }}>
        <div className="relative flex items-center justify-around">
          ...
          <button className="relative flex flex-col items-center min-w-0 py-1 z-10" onClick={() => router.push('/student/dashboard')}>
          ...
          <button className="flex flex-col items-center min-w-0 py-1 z-10" onClick={() => router.push('/student/assignments')}>
          ...
          <button className="relative flex flex-col items-center min-w-0 py-1 z-10" onClick={() => router.push('/student/courses')}>
          ...
          <button className="relative flex flex-col items-center min-w-0 py-1 z-10" onClick={() => router.push('/student/profile')}>
