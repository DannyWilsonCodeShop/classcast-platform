    ...
    <>
      ...
      <nav className="fixed bottom-4 left-4 right-4 z-40 px-2 py-2 rounded-2xl native-bottom-nav" style={{ background: 'rgba(255,255,255,0.65)', backdropFilter: 'blur(12px) saturate(150%)', WebkitBackdropFilter: 'blur(12px) saturate(150%)', border: '1px solid rgba(255,255,255,0.5)', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
        <div className="relative flex items-center">
          ...
          <button className="relative flex flex-col items-center w-1/5 py-1 z-10" onClick={() => { animateToTab(0); router.push('/student/dashboard'); }}>
          ...
          <button className="flex flex-col items-center w-1/5 py-1 z-10" onClick={() => { animateToTab(1); router.push('/student/assignments'); }}>
          ...
          <button className="relative flex flex-col items-center w-1/5 py-1 z-10" onClick={() => { animateToTab(3); router.push('/student/courses'); }}>
