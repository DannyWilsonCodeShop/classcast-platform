...
export default function PublicStudyHallPage() {
  ...
  return (
    <div className="h-[100dvh] bg-[#faf9f7] flex flex-col">
      ...
      {/* Header */}
      <div className="bg-[#f0f4f8] text-[#005587] px-4 py-3 flex items-center justify-between safe-top shrink-0 border-b border-[#e2e8f0]">
      ...
      {/* Tab bar */}
      <div className="flex border-b border-[#e2e8f0] shrink-0 bg-[#f0f4f8]">
        <button
