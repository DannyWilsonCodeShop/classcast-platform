...
export default function StudentAssignmentDetailPage() {
  ...
  return (
    <StudentRoute>
        ...
        <nav className="fixed bottom-4 left-4 right-4 z-40 px-2 py-2 rounded-2xl native-bottom-nav" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(24px) saturate(180%)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', border: '1px solid rgba(255,255,255,0.25)', boxShadow: '0 8px 32px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.3)' }}>
          {!isSubmitted && (
            <div className="relative flex items-center justify-around">
              ...
              <div className="flex flex-col items-center min-w-0 py-1 z-10">
              ...
              <button onClick={() => { animateToTab(2); setTimeout(() => setShowPostModal(true), 450); }} className="flex flex-col items-center min-w-0 py-1 z-10">
      ...
      {showPostModal && (
        <div className="fixed inset-0 z-50 flex items-end justify-center" onClick={() => { setShowPostModal(false); setShowLinkInput(false); setPostError(''); setTimeout(() => animateToTab(1), 280); }}>
