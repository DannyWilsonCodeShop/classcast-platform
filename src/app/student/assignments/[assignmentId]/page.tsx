    ...
    <StudentRoute>
      ...
      <div ref={swipeContainerRef} className="h-full flex flex-col bg-white overflow-hidden" style={{ touchAction: 'pan-y' }}>
        ...
        <nav className="fixed bottom-4 left-4 right-4 z-40 px-2 py-2 rounded-2xl native-bottom-nav" style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(24px) saturate(180%)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', border: '1px solid rgba(255,255,255,0.25)', boxShadow: '0 8px 32px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.3)' }}>
          {!isSubmitted && (
            <div className="flex items-center justify-around">
              <button onClick={() => router.push('/student/dashboard')} className="flex flex-col items-center min-w-0 py-1"><svg className="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg><span className="text-[9px] text-gray-400">Home</span></button>
              <div className="flex flex-col items-center min-w-0 py-1">
              ...
              <button onClick={() => setShowPostModal(true)} className="flex flex-col items-center min-w-0 py-1">
          ...
          {isSubmitted && !isGraded && (
            <div className="flex items-center justify-around">
              <button onClick={() => router.push('/student/dashboard')} className="flex flex-col items-center min-w-0 py-1"><svg className="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg><span className="text-[9px] text-gray-400">Home</span></button>
              <div className="flex flex-col items-center min-w-0 py-1"><span className="text-[9px] font-bold text-green-600">✓ Submitted!</span></div>
              <button onClick={() => router.push(`/student/assignments/${assignmentId}/feed`)} className="flex flex-col items-center min-w-0 py-1">
          ...
          {isGraded && (
            <div className="flex items-center justify-around">
              <button onClick={() => router.push('/student/dashboard')} className="flex flex-col items-center min-w-0 py-1"><svg className="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg><span className="text-[9px] text-gray-400">Home</span></button>
              <div className="flex flex-col items-center min-w-0 py-1"><span className="text-xs font-bold text-green-600 bg-green-50 px-2 py-1 rounded-full">{submission!.grade}/{assignment.points || assignment.maxScore || 100}</span><span className="text-[8px] text-gray-400 mt-0.5">Grade</span></div>
              <button onClick={() => router.push(`/student/assignments/${assignmentId}/feed`)} className="flex flex-col items-center min-w-0 py-1">
                <svg className="w-6 h-6 text-[#005587]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                <span className="text-[9px] text-[#005587]">Peers</span>
              </button>
