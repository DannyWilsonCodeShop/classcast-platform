...
const CristoReySimpleDashboard: React.FC = () => {
  ...
  // Cristo Rey Brand Colors
  const cristoReyBlue = '#0056b3';
  const cristoReyGold = '#f4c430';
  const cristoReyBlueDark = '#003d82';
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              <div 
                ...
                style={{ background: `linear-gradient(135deg, ${cristoReyBlue} 0%, ${cristoReyGold} 100%)` }}
              >
                CR
              </div>
            </div>
            <h2 style={{ fontFamily: 'Times New Roman, serif', color: cristoReyBlue }} className="text-3xl font-bold mb-2">
              Cristo Rey Atlanta
            </h2>
            <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#666' }} className="text-lg mb-4">Jesuit High School</p>
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto mb-4"></div>
            <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif' }}>Loading your dashboard...</p>
          </div>
        </div>
      </StudentRoute>
    );
      ...
      <StudentRoute>
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="text-center max-w-md mx-auto p-6">
            ...
            <h2 style={{ fontFamily: 'Times New Roman, serif', color: cristoReyBlue }} className="text-2xl font-bold mb-2">Error Loading Dashboard</h2>
            <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif' }} className="mb-6">{error}</p>
            <button
              onClick={() => window.location.reload()}
              className="px-6 py-3 rounded-lg text-white font-medium hover:opacity-90 transition-opacity"
              style={{ backgroundColor: cristoReyBlue }}
            >
              Try Again
            </button>
          </div>
      ...
      <StudentRoute>
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="text-center">
            ...
            <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#666' }} className="text-lg mb-4">Jesuit High School</p>
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto mb-4"></div>
            <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif' }}>Redirecting to login...</p>
          </div>
        </div>
      </StudentRoute>
    );
  ...
  return (
    <StudentRoute>
      <div className="h-screen overflow-hidden flex flex-col bg-gray-50">
        {/* Cristo Rey Branded Header */}
        <div 
          className="px-4 py-4 shadow-lg"
          style={{ background: `linear-gradient(135deg, ${cristoReyBlue} 0%, ${cristoReyBlueDark} 100%)` }}
        >
          <div className="flex items-center justify-between">
            {/* Left Side - Cristo Rey Logo */}
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 style={{ fontFamily: 'Times New Roman, serif', color: 'white' }} className="text-2xl font-bold">CRISTO REY ATLANTA</h1>
                <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: 'rgba(255,255,255,0.9)', fontStyle: 'italic', letterSpacing: '0.05em' }} className="text-sm">JESUIT HIGH SCHOOL</p>
              </div>
            </div>
            
            {/* Right Side - Join Class Button and Profile */}
            <div className="flex items-center space-x-4">
              <button
                onClick={() => setShowEnrollmentModal(true)}
                className="px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity flex items-center"
                style={{ backgroundColor: cristoReyGold, color: cristoReyBlueDark }}
        ...
        {/* Status Bar */}
        <div className="text-white px-4 py-2" style={{ backgroundColor: cristoReyBlue }}>
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
          {/* Left Sidebar - Videos and Community */}
          <div className="hidden lg:block w-80 bg-white border-r border-gray-200 flex flex-col">
            ...
            <div className="flex-1 p-4 border-b border-gray-200">
              <div className="mb-4">
                <h3 style={{ fontFamily: 'Times New Roman, serif', color: cristoReyBlue }} className="text-lg font-bold mb-2">Recently Posted</h3>
              </div>
            ...
            <div className="flex-1 p-4">
              <div className="mb-3">
                <h3 style={{ fontFamily: 'Times New Roman, serif', color: cristoReyBlue }} className="text-lg font-bold mb-2">Community</h3>
                <button 
                  onClick={() => router.push('/community')}
                  className="w-full px-4 py-2 rounded-lg text-white font-medium mb-3 hover:opacity-90 transition-opacity"
                  style={{ backgroundColor: cristoReyBlue }}
                >
                  💬 Go to Community
                </button>
                ...
                {isLoadingPosts ? (
                  ...
                  <div className="space-y-3">
                    {communityPosts.slice(0, 5).map((post) => (
                      <div key={post.id} className="bg-white rounded-lg p-3 border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all cursor-pointer group"
                        ...
                        <div className="flex items-start space-x-2">
                            ...
                            onError={(e) => {
                              ...
                              if (parent) {
                                ...
                                fallback.className = `w-7 h-7 rounded-full flex items-center justify-center text-white text-xs font-bold ${
                                  post.isAnnouncement ? 'bg-blue-600' : 'bg-green-600'
                                }`;
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-1 mb-1">
                              ...
                              {post.isAnnouncement && (
                                <span 
                                  className="px-1 py-0.5 text-white text-xs rounded-full flex-shrink-0"
                                  style={{ backgroundColor: cristoReyBlue }}
                                >
                                  📢
                                </span>
                            ...
                            <div className="flex items-center justify-between mt-2">
                              <div className="flex items-center space-x-2">
                                <button 
                                  ...
                                  className="flex items-center space-x-1 text-xs text-gray-400 hover:text-blue-600 transition-colors"
                                >
                                  <span>👍</span>
          ...
          <div className="flex-1 overflow-y-auto p-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mb-6">
                <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                  <div className="flex items-center justify-between mb-3">
                    <h2 style={{ fontFamily: 'Times New Roman, serif', color: cristoReyBlue }} className="text-lg font-bold flex items-center">
                  ...
                  {isLoadingTodoStats ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {/* Pending Reviews - Cristo Rey Styled */}
                      <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg border-2 border-blue-300 hover:border-blue-400 hover:shadow-md transition-all cursor-pointer group"
                           onClick={() => router.push('/student/peer-reviews')}>
                        <div className="flex-shrink-0">
                          <div 
                            className="w-10 h-10 rounded-lg flex items-center justify-center shadow-md group-hover:scale-110 transition-transform text-white"
                            style={{ backgroundColor: cristoReyBlue }}
                          >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            ...
                            {todoStats.pendingReviews > 0 ? (
                              <span 
                                className="px-2 py-0.5 text-white text-xs font-bold rounded-full animate-pulse"
                                style={{ backgroundColor: cristoReyBlue }}
                              >
                                {todoStats.pendingReviews} NEW
                              </span>
                            ) : (
                              <span className="text-lg font-bold" style={{ color: cristoReyBlue }}>{todoStats.pendingReviews}</span>
                            )}
                          </div>
                          <p className="text-xs text-gray-600 mt-0.5">Watch & respond to peer videos</p>
                        </div>
                        <div className="flex-shrink-0">
                          <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" style={{ color: cristoReyBlue }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <div className="flex space-x-3">
                        ...
                        {todoStats.pendingReviews > 0 && (
                          <button 
                            onClick={() => router.push('/student/peer-reviews')}
                            className="px-3 py-1 rounded-lg text-white text-sm font-medium hover:opacity-90 transition-opacity"
                            style={{ backgroundColor: cristoReyBlue }}
                          >
              ...
              {/* My Classes Header */}
              <div className="mb-6">
                <h1 style={{ fontFamily: 'Times New Roman, serif', color: cristoReyBlue }} className="text-3xl font-bold mb-2">My Classes</h1>
              </div>
                ...
                {isLoadingCourses ? (
                  ...
                  courses.map((course) => (
                    <div
                      ...
                      className="bg-white rounded-lg border border-gray-200 p-6 hover:border-blue-300 hover:shadow-md cursor-pointer transition-all group"
                    ...
                    >
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 style={{ fontFamily: 'Times New Roman, serif' }} className="text-lg font-bold text-gray-900 truncate group-hover:text-blue-600 transition-colors">
                            {course.name}
                          </h3>
                          <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif' }} className="text-sm text-gray-600">Class Code: {course.code}</p>
                        </div>
                      </div>
                      
                      <div className="flex items-center justify-end pt-2">
                        <div style={{ color: cristoReyBlue }} className="group-hover:text-blue-800 transition-colors">
                  ...
                  <div className="col-span-full">
                    <div className="text-center py-12">
                      ...
                      <h3 style={{ fontFamily: 'Times New Roman, serif' }} className="text-xl font-bold text-gray-900 mb-2">No Classes Yet</h3>
                      <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif' }} className="text-gray-600 mb-6">You haven't enrolled in any classes yet. Contact your instructor to get started!</p>
                      <button
        ...
        {/* Cristo Rey Branded Footer */}
        <div className="text-white px-4 py-3 flex-shrink-0" style={{ backgroundColor: cristoReyBlue }}>
          <div className="flex items-center justify-between text-xs">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center">
                  <span style={{ color: cristoReyBlue }} className="font-bold text-xs">CR</span>
                </div>
                <span className="font-semibold">Cristo Rey Atlanta Jesuit High School</span>
              </div>
              <span>•</span>
              <span>AI-Powered Learning Platform</span>
            </div>
            <div className="flex items-center space-x-4">
              <span>© 2025 Cristo Rey Atlanta</span>
              <span>•</span>
...
export default CristoReySimpleDashboard;
