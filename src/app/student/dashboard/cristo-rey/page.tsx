...
const CristoReyStudentDashboard: React.FC = () => {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-gray-50 to-blue-100">
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              <div className="cristo-rey-logo-emblem">
                CR
              </div>
            </div>
            <h2 className="cristo-rey-heading text-3xl mb-2">
              Cristo Rey Atlanta
            </h2>
            <p className="cristo-rey-body text-lg mb-4">Jesuit High School</p>
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto mb-4"></div>
            <p className="cristo-rey-body">Loading your dashboard...</p>
          </div>
        </div>
      </StudentRoute>
    );
      ...
      <StudentRoute>
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-gray-50 to-blue-100">
          <div className="text-center max-w-md mx-auto p-6">
            ...
            <h2 className="cristo-rey-heading text-2xl mb-2">Error Loading Dashboard</h2>
            <p className="cristo-rey-body mb-6">{error}</p>
            <button
              onClick={() => window.location.reload()}
              className="cristo-rey-btn-primary"
            >
              Try Again
            </button>
          </div>
      ...
      <StudentRoute>
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-gray-50 to-blue-100">
          <div className="text-center">
            ...
            <p className="cristo-rey-body text-lg mb-4">Jesuit High School</p>
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto mb-4"></div>
            <p className="cristo-rey-body">Redirecting to login...</p>
          </div>
        </div>
      </StudentRoute>
    );
  ...
  return (
    <StudentRoute>
      <div className="h-screen overflow-hidden flex flex-col bg-gray-50">
        ...
        <div className="cristo-rey-header px-4 py-4 shadow-lg">
          <div className="flex items-center justify-between">
            {/* Left Side - Cristo Rey Logo */}
            <div className="cristo-rey-logo-container">
              <div className="cristo-rey-logo-emblem">
                CR
              </div>
              <div>
                <h1 className="cristo-rey-logo-text text-2xl">CRISTO REY ATLANTA</h1>
                <p className="cristo-rey-logo-subtitle text-sm">JESUIT HIGH SCHOOL</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="cristo-rey-btn-secondary"
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
          ...
          <div className="hidden lg:block w-80 bg-white border-r border-gray-200 flex flex-col">
            ...
            <div className="flex-1 p-4 border-b border-gray-200">
              <div className="mb-4">
                <h3 className="cristo-rey-heading text-lg mb-2">Recently Posted</h3>
              </div>
            ...
            <div className="flex-1 p-4">
              <div className="mb-3">
                <h3 className="cristo-rey-heading text-lg mb-2">Community</h3>
                <button 
                  onClick={() => router.push('/community')}
                  className="w-full cristo-rey-btn-primary mb-3"
                >
                  💬 Go to Community
                </button>
              </div>
                ...
                {isLoadingPosts ? (
                  ...
                  <div className="space-y-3">
                    {communityPosts.slice(0, 5).map((post) => (
                      <div key={post.id} className="cristo-rey-card p-3 cursor-pointer group"
                        ...
                        <div className="flex items-start space-x-2">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-1 mb-1">
                              ...
                              {post.isAnnouncement && (
                                <span className="cristo-rey-badge cristo-rey-badge-blue text-xs">
                                  📢
                                </span>
                              )}
                            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mb-6">
                <div className="cristo-rey-card p-4">
                  <div className="flex items-center justify-between mb-3">
                    <h2 className="cristo-rey-heading text-lg flex items-center">
                  ...
                  {isLoadingTodoStats ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center space-x-3 p-3 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg border-2 border-blue-300 hover:border-blue-400 hover:shadow-md transition-all cursor-pointer group"
                           onClick={() => router.push('/student/peer-reviews')}>
                        <div className="flex-shrink-0">
                          <div className="w-10 h-10 cristo-rey-status-blue rounded-lg flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                            <span className="text-white text-lg">🎥</span>
                          </div>
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            ...
                            {todoStats.pendingReviews > 0 ? (
                              <span className="cristo-rey-badge cristo-rey-badge-blue text-xs animate-pulse">
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <div className="flex space-x-3">
                        ...
                        {todoStats.pendingReviews > 0 && (
                          <button 
                            onClick={() => router.push('/student/peer-reviews')}
                            className="cristo-rey-btn-primary px-3 py-1 text-sm"
                          >
              ...
              {/* My Classes Header */}
              <div className="mb-6">
                <h1 className="cristo-rey-heading text-3xl mb-2">My Classes</h1>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {isLoadingCourses ? (
                  ...
                  <div className="col-span-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                      {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="cristo-rey-card p-6 animate-pulse">
                  ...
                  courses.map((course) => (
                    <div
                      ...
                      className="cristo-rey-card p-6 cursor-pointer group"
                    ...
                    >
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="cristo-rey-heading text-lg truncate group-hover:text-blue-600 transition-colors">
                            {course.name}
                          </h3>
                          <p className="cristo-rey-body text-sm">Class Code: {course.code}</p>
                        </div>
                      </div>
                  ...
                  <div className="col-span-full">
                    <div className="text-center py-12">
                      ...
                      <h3 className="cristo-rey-heading text-xl mb-2">No Classes Yet</h3>
                      <p className="cristo-rey-body mb-6">You haven't enrolled in any classes yet. Contact your instructor to get started!</p>
                      <button
...
export default CristoReyStudentDashboard;
