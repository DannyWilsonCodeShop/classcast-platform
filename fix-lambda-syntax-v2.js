...
async function updateLambdaFunction(functionName) {
  try {
    ...
    // Create zip file
    const zipFile = `/tmp/${functionName}.zip`;
    ...
    // Clean up
    execSync(`rm -rf ${tempDir} ${zipFile}`);
...
async function updateAllLambdaFunctions() {
  console.log('🔧 Fixing Lambda function syntax errors with proper zip files...\n');
