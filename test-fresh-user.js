...
// Test fresh user creation and immediate login
const testFreshUser = () => {
  const signupData = {
  ...
  const req = https.request(options, (res) => {
    ...
    res.on('end', () => {
      ...
      if (res.statusCode === 201) {
        ...
        console.log('Now testing login immediately...');
        
        // Test login after 3 seconds
...
const testLogin = () => {
  ...
  console.log('Testing login for fresh user...');
